...
const CACHE_NAME = 'brightnews-v17'; // v17: parkeerbericht op de homepage zelf i.p.v. een doorverwijzing (v15/v16 zijn geclaimd door PR #5 en #1). Bumpen bij elke wijziging aan ASSETS-bestanden.
const ASSETS = [
    '/',
    '/index.html',
    '/css/global.css',
