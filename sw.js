...
const CACHE_NAME = 'brightnews-v27'; // v27: feedbackvenster uit de footer (punt 35) kwam erbij in css/components.css. Bumpen bij elke wijziging aan ASSETS-bestanden.
const ASSETS = [
    '/',
    '/index.html',
    '/css/global.css',
